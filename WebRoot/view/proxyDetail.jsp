...
<!--  	<link href='http://fonts.useso.com/css?family=Roboto:400,100,300,500,700,900' rel='stylesheet' type='text/css'>
	...
	<script type="text/javascript">
		...
		function getPaylog(pageIndex,type){
			$.ajax({	
				   type: "POST",
				   url: "<%=basePath%>controller/manager/getPaylogs?pageType=proxy&pageNum="+pageIndex+"&type="+type,
				   data: "",
		...
		function getAccount(pageIndex,type){
			$.ajax({	
				   type: "POST",
				   url: "<%=basePath%>controller/manager/getManagers?pageType=proxy&pageNum="+pageIndex,
				   data: "",
				   success: function data(data){
					   var returns =  eval('(' + data + ')');
		...
		function getUser(pageIndex,type){
			$.ajax({	
				   type: "POST",
				   url: "<%=basePath%>controller/manager/getAccounts?pageType=proxy&type=proxy&pageNum="+pageIndex,
				   data: "",
				   success: function data(data){
					   var returns =  eval('(' + data + ')');
		...
		function getTixianlog(pageIndex,type){
			$.ajax({	
				   type: "POST",
				   url: "<%=basePath%>controller/manager/getPaylogs?pageType=proxy&pageNum="+pageIndex+"&payType=1&type="+type,
				   data: "",
				   success: function data(data){
					   var returns =  eval('(' + data + ')');
						var param = returns.paylogs;
		...
		function getPaylogSum(type){
			$.ajax({	
				   type: "POST",
				   url: "<%=basePath%>controller/manager/getPaylogsSum?pageType=proxy&type="+type,
				   data: "",
				   success: function data(data){
					   var returns =  eval('(' + data + ')');
		...
		function selectPage(clickPage) {
			if(clickPage == "user"){
				...
				$.ajax({	
				   type: "POST",
				   url: "<%=basePath%>controller/manager/getAccounts?pageType=proxy&type=proxy&pageNum=1",
				   data: "",
				   success: function data(data){
					   var returns =  eval('(' + data + ')');
						var param = returns.users;
		    ...
		    if(clickPage == "account"){
		    	...
		    	$.ajax({	
				   type: "POST",
				   url: "<%=basePath%>controller/manager/getManagers?pageType=proxy&pageNum=1",
				   data: "",
				   success: function data(data){
					   var returns =  eval('(' + data + ')');
						var param = returns.managers;
		    ...
		    if(clickPage == "paylog"){
		    	...
		    	$.ajax({	
				   type: "POST",
				   url: "<%=basePath%>controller/manager/getPaylogs?pageType=proxy&pageNum=1&payType=0",
				   data: "",
				   success: function data(data){
					   var returns =  eval('(' + data + ')');
						var param = returns.paylogs;
		    ...
		    if(clickPage == "tixianlog"){
		    	...
		    	$.ajax({	
				   type: "POST",
				   url: "<%=basePath%>controller/manager/getPaylogs?pageType=proxy&pageNum=1&&payType=1",
				   data: "",
				   success: function data(data){
					   var returns =  eval('(' + data + ')');
						var param = returns.paylogs;
		    ...
		    if(clickPage == "paylogsum"){
		    	...
		    	$.ajax({	
				   type: "POST",
				   url: "<%=basePath%>controller/manager/getPaylogsSum?pageType=proxy&type=0",
				   data: "",
				   success: function data(data){
					   var returns =  eval('(' + data + ')');
						var total = returns.total;
