		...
		<div id="wrapper">
			<div class="navbar-default sidebar" role="navigation">
				<div class="base_info">
					...
					<span  class="info_item">历史房卡总数：<span id="totalCards" class="info_items"></span></span>
					<span class="info_item">剩余房卡总数：<span id="actualCard" class="info_items"></span></span>
				...
				<div class="selfinfo_frame mobile_display" id="mobileUserInfo">
					...
					<span  class="info_ite">历史房卡总数：<span id="totalCards_mobile" class="info_ite"  ></span></span>
					<span class="info_ite">剩余房卡总数：<span id="actualCard_mobile" class="info_ite"  ></span></span>
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li class="tltle_nav">
							<a href="#summary" onclick="selectPage('summary')"><i class="fa fa-envelope nav_icon"></i>概况</a>
						</li>

						<li class="tltle_nav">
							<a href="#user" onclick="selectPage('user')"><i class="fa fa-envelope nav_icon"></i>游戏会员管理<span class="fa arrow"></span></a>
						</li>
						<li class="tltle_nav">
							<a href="#activity" onclick="selectPage('activity')"><i class="fa fa-envelope nav_icon"></i>活动管理<span class="fa arrow"></span></a>
						</li>
						...
						<li class="tltle_nav">
							<a onclick="selectPage('user')" href="#roomCard"><i class="fa fa-envelope nav_icon"></i>钻石操作<span class="fa arrow"></span></a>
						</li>
						...
						<li class="tltle_nav">
							<a href="#roomCardFlow" onclick="selectPage('roomCardFlow')"><i class="fa fa-envelope nav_icon"></i>房卡流水查询<span class="fa arrow"></span></a>
						</li>
						<li class="tltle_nav">
							<a href="#operationFlow" onclick="selectPage('operationFlow')"><i class="fa fa-envelope nav_icon"></i>操作流水查询<span class="fa arrow"></span></a>
						</li>
					</ul>
				</div>
			...
			<div id="page-wrapper">
				<div class="graphs" id="summary">
					<div class="col_3">
						...
						<label  style="margin-left: 5%;font-size:18px">当前公告： &nbsp;&nbsp;&nbsp;</label>
						<p style="margin-left: 5%">
							<textarea id="gameOldNotice"  style=" width: 80%;margin-top: 5px;height: 75px;"></textarea>
						</p>
						<label  style="margin-left: 5%;font-size:18px;color:red">发布新公告：</label>
						<p style="margin-left: 5%">
							<textarea id="gameNotice"  style=" width: 80%;height: 75px; margin-top: 5px;"> </textarea>
					...
					<div class="col_3">
						...
						<p style="margin-left: 5%">
							<textarea id="newContact"  style=" width: 80%;height: 150px; margin-top: 5px;"> </textarea>
							<button  onclick="saveContactway()"  style="border: 1px solid #00BCD4; border-radius: 5px; background: none; padding-left: 8px; padding-right: 8px;">保存</button>
						</p>
					...
					<div class="col_3">
						...
						<div class="col-md-3 widget widget1">
							<div class="r3_counter_box">
								...
								<div class="stats">
									<h5><strong id="totoalAccountCount"></strong></h5>
									<span>玩家总数</span>
								</div>
							</div>
						</div>
						<div class="col-md-3 widget widget1">
							<div class="r3_counter_box">
								...
								<div class="stats">
									<h5><strong id="consumedRoomCardCount"></strong></h5>
									<span>消耗房卡历史总数</span>
								</div>
							</div>
						</div>
						<div class="col-md-3 widget widget1">
							<div class="r3_counter_box">
								<i class="pull-left fa fa-users user1 icon-rounded"></i>
								<div class="stats">
									<h5><strong id="AllRoomsCount"></strong></h5>
									<span>房间创建历史总数</span>
								</div>
							</div>
						</div>
					...
					<div class="col_3">
						...
						<div class="col-md-3 r3_counter_box" style="height: 100px; float: left; width:48%;">
							...
							<div style="text-align: center;">
								...
								<div>
									<h5><strong id="onlineRoomsCount"></strong></h5>
									<span>当前在线房间总数</span>
								</div>
							</div>
						</div>
						<div class="col-md-3 r3_counter_box" style="float: right;height: 100px;width:48%;">
							<div style="text-align: center;">
								...
								<div>
									<h5><strong id="todayRoomsCount"></strong></h5>
									<span>今天创建房间总数</span>
								</div>
							</div>
						</div>
					...
					<div class="col_3">
						...
						<div class="col-md-3 widget widget1">
							...
							<div class="r3_counter_box">
								<i class="pull-left fa fa-thumbs-up icon-rounded"></i>
								<div class="stats">
									<h5><strong id="totalRoomCards"></strong></h5>
									<span>充值房卡历史总数</span>
								</div>
							</div>
						</div>
						<div class="col-md-3 widget widget1">
							<div class="r3_counter_box">
								<i class="pull-left fa fa-users user1 icon-rounded"></i>
								<div class="stats">
									<h5><strong id="saleRoomCardsToday"></strong></h5>
									<span>当天充值房卡总数</span>
								</div>
							</div>
						</div>
						<div class="col-md-3 widget widget1">
							<div class="r3_counter_box">
								...
								<div class="stats">
									<h5><strong id="saleRoomCardsThisWeek"></strong></h5>
									<span>本周充值房卡总数</span>
								</div>
							</div>
						</div>
					...
					<div class="col_3">
						...
						<div class="col-md-3 widget widget1">
							<div class="r3_counter_box">
								<i class="pull-left fa fa-users user1 icon-rounded"></i>
								<div class="stats">
									<h5><strong id="onlineAccountCount"></strong></h5>
									<span>当前在线人数</span>
								</div>
							</div>
						</div>
						<div class="col-md-3 widget widget1">
							<div class="r3_counter_box">
								<i class="pull-left fa fa-comment user2 icon-rounded"></i>
								<div class="stats">
									<h5><strong id="topOnlineAccountCount"></strong></h5>
						...
						<div class="col-md-3 widget widget1">
							<div class="r3_counter_box">
								<i class="pull-left fa fa-comment user2 icon-rounded"></i>
								<div class="stats">
									<h5><strong id="newAccountCountToday"></strong></h5>
									<span>今日新增用户</span>
								</div>
							</div>
						</div>
					...
					<div class="col_3">
						...
						<div style="clear：both; margin-top: 25px;padding-bottom: 5px; margin-left: 20px; margin-right: 20px; border: #d0d0d0 solid 1px; padding-left: ;" id="gift_rule_set">
							...
							<p style="margin-top: 15px;">
								<p>抽奖状态：<input  id="prizeType" style="color:red" onclick="changeStatus(this.value)"  type="button" value=""/>
							</p>
							<p style="margin-top: 15px;">
								<p>奖品规则说明<input  id="prizePerDay" placeholder="填写每天抽奖次数" width="120px" />
							</p>
							
							<div style="margin-top: 15px;">
								<p>奖品规则说明</p>
								<textarea  id="prizeRule" placeholder="奖品规则说明" style="width: 80% ;margin-left: 10%; height: 80px;" ></textarea>
							</div>
							<p style="clear: both; height: 35px;">
								<button style="width: 60px; height: 35px; float: right; margin-right: 5px;" onclick="prizeRule()">保存</button>
							</p>
						</div>
						<!--奖品设置框 -->
				...
				<div class="graphs" id="account">
					<div class="col_3">
						...
						<button style="float: right; line-height: 30px; margin-top: 5px;" onclick="searchManager()">搜索代理</button>
							<input id="managerTel" type="text" value="请输入代理手机号码" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '请输入代理手机号码';}" style="float: right;line-height: 30px; margin-top: 5px;color:black; margin-right: 15px;" />
						<table class="table" style="border-top: 1px #C0C0C0 solid;margin-top: 20px;">
							<thead>
								<tr class="success">
									<th>账号</th>
				...
				<!-- Modal  增加新用户账户-->
				<div id="myModal" class="modal fade modal_style"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				...
				<div id="updatePwdModal" class="modal fade modal_style"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					...
					<div class="modal-body" style="padding: 30px; height: 140px;">
						<div style="clear: both;">
							...
							<span style="float: right;">旧手机号：<input id="oldTel"  placeholder="输入旧手机号"/></span>
						</div>
						...
						<div style="clear: both;margin-top: 80px;">
							...
							<span style="float: right;">新手机号：<input id="twoTel"  placeholder="再次输入新手机号"/></span>
						</div>
					</div>
					<div class="modal-footer">
						<button class="btn" data-dismiss="modal" aria-hidden="true">取消</button>
				...
				<!-- 代理退卡模块 -->
				<div id="reduceRoomCardModal" class="modal fade modal_style"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					...
					<div class="modal-body" style="padding: 30px; height: 120px;">
						...
						<span>减少房卡数</span><input  id="reduceManagerCardNum" placeholder="请输入减少房卡数" />
					</div>
					<div class="modal-footer">
						<button class="btn" data-dismiss="modal" aria-hidden="true">取消</button>
						<button class="btn btn-primary" data-dismiss="modal" aria-hidden="true" onclick="reduceManagerRoomCard()">确认</button>
					</div>
				</div>
				<!-- 找回代理商密码 -->
				...
				<!-- 玩家退卡模块 -->
				<div id="reduceAccountRoomCardModal" class="modal fade modal_style"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					...
					<div class="modal-body" style="padding: 30px; height: 120px;">
						<div style="color: red;margin-bottom: 20px;">退卡将影响用户的体验和正常使用，请谨慎操作</div>
						<span>减少房卡数</span><input  id="reduceAccountCardNum" placeholder="请输入减少房卡数" />
					</div>
					<div class="modal-footer">
						<button class="btn" data-dismiss="modal" aria-hidden="true">取消</button>
						<button class="btn btn-primary" data-dismiss="modal" aria-hidden="true" onclick="reduceAccountRoomCard()">确认</button>
					</div>
				</div>
		...
		function selectPage(clickPage) {
		 ...
		 if(clickPage == "operationFlow"){
		    ...
		    if(clickPage == "paylog"){
		    	...
		    	$.ajax({	
				   type: "POST",
				   url: "<%=basePath%>controller/manager/getPaylogs?pageNum=1",
				   data: "",
				   success: function data(data){
					   var returns =  eval('(' + data + ')');
						var param = returns.paylogs;
		    ...
		    if(clickPage == "paylogsum"){
		    	...
		    	$.ajax({	
				   type: "POST",
				   url: "<%=basePath%>controller/manager/getPaylogsSum?type=1",
				   data: "",
				   success: function data(data){
					   var returns =  eval('(' + data + ')');
						var total = returns.total;
