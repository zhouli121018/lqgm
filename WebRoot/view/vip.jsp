        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form class="form-inline form-btn text-right">
                    ...
                    <input type="text" class="search" id="accountUuid" placeholder="请输入玩家id"/>
			   ...
			   var returns =  eval('(' + data + ')');
		        ...
		        $.each(param, function (i, item) {  
		              var td = "<td>"+param[i].uuid+"</td>";
									...
									if(param[i].status==0){
										td+="<td><a class='btn btn-success btn-sm'>充值</a>&nbsp; <a class='btn btn-danger btn-sm disable' title='"+param[i].id+"'>禁用</a></td>";
									}else{
										td+="<td><a class='btn btn-success btn-sm'>充值</a>&nbsp; <a class='btn btn-warning btn-sm disable' title='"+param[i].id+"'>启用</a></td>";
									}
					...
					if(param.status_code == "0"){
					     ...
					     var td = "<td>"+param.data.uuid+"</td>";
								...
								td+="<td class='roomCard'>"+param.data.roomcard+"</td>";
									...
									if(param.data.status==0){
										td+="<td><a class='btn btn-success btn-sm'>充值</a>&nbsp; <a class='btn btn-danger btn-sm disable' title='"+param.data.id+"'>禁用</a></td>";
									}else{
										td+="<td><a class='btn btn-success btn-sm'>充值</a>&nbsp; <a class='btn btn-warning btn-sm disable' title='"+param.data.id+"'>启用</a></td>";
									}
							//添加每行数据
							$("#userTbody").append("<tr>"+td+"</tr>");
					}
